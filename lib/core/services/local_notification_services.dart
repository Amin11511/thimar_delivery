...
class GlobalNotification {
  ...
  Map<String, dynamic> _not = <String, String>{};
  ...
  Future<void> setUpFirebase() async {
    ...
    const InitializationSettings initSetting = InitializationSettings(android: android, iOS: ios);
  ...
  Future<void> showNotification(RemoteMessage data) async {
    ...
    const NotificationDetails notificationDetails = NotificationDetails(android: androidChannelSpecifics, iOS: iOSPlatformSpecifics);
