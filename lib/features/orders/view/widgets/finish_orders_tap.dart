...
class _FinishOrdersTapState extends State<FinishOrdersTap> {
  ...
  void initState() {
    super.initState();
    widget.orderCubit.getFinishedOrders();
  }
      ...
      child: BlocBuilder<OrdersCubit, OrdersState>(
        builder: (context, state) {
          if (state.ordersState == RequestState.loading) {
            return const Center(child: AppLoadingIndicatorWidget());
      ...
      children: [
        Expanded(
          child: ListView.builder(
            ...
            shrinkWrap: true,
            controller: widget.orderCubit.scrollController,
        ...
        BlocBuilder<OrdersCubit, OrdersState>(
          builder: (context, state) {
            if (state.isLoadingMore == true) {
              return const AppLoadingIndicatorWidget();
            } else {
